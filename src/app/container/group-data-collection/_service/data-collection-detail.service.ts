...
export class DataCollectionDetailService {
  ...
  setExtraList() {
    return [
      new DataOption('physicalTemperature', '病程与治疗情况'),
      new DataOption('physicalPulse', '治疗结果'),
      new DataOption('physicalRespiration', '出院时情况'),
      new DataOption('physicalBloodPressure', '出院用药及建议')
    ];
  }
